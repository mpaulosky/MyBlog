...
echo "  4. Unit/arch/bUnit tests (Architecture.Tests, Domain.Tests, Web.Tests, Web.Tests.Bunit)"
echo "  5. Integration + E2E tests (Web.Tests.Integration, AppHost.Tests — Docker required)"
echo ""
