...
2. **Boromir** (DevOps) — _(I've already verified CI/infra; PR author cannot self-approve)_
...
- The actual gate is _transparency_: PR authors must document why coverage decreased, not a rigid 1% threshold
