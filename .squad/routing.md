...
| NuGet/Azure/Microsoft API reference during CI/CD | `.squad/skills/microsoft-code-reference/SKILL.md` | Any Boromir task verifying NuGet package versions, Aspire AppHost resources, GitHub Actions patterns, .NET Framework compatibility, or NuGet package signatures. Owner: Boromir (DevOps). Sprint 2 rewrite: now focused on MyBlog DevOps/NuGet/GitHub Actions/Aspire patterns. |
